...
public class JumpPad : MonoBehaviour
{
    ...
    {
        ThirdPersonCharacterController playerController = collision.gameObject.GetComponentInParent<ThirdPersonCharacterController>();
        if (playerController != null)
        {
            playerController.ResetJumps();
            playerController.Bounce(regularBounceForceMultiplyer, jumpHeldBounceForceMultiplyer, false);
